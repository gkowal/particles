...
!$  write (*,"(19('='),10x,'OpenMP:',i5,1x,'threads  ',10x,19('='))") npar
  ...
  iret = 0
  call read_parameters(.true., iret)

  call get_parameter("simulation"   , simulation)
  call get_parameter("method"       , method    )
  call get_parameter("particle_type", ptype     )
  call get_parameter("time_scale"   , tscale    )
  call get_parameter("nparticles"   , nparticles)
  call get_parameter("nsteps"       , nsteps    )
  call get_parameter("bunit"        , bunit     )
  call get_parameter("vunit"        , vunit     )
  call get_parameter("tunit"        , tunit     )
  call get_parameter("temperature"  , temp      )
  ...
  call get_parameter("zmax"         , zmax_domain)
  call get_parameter("xmin_domain"  , xmin_domain)
  call get_parameter("ymin_domain"  , ymin_domain)
  call get_parameter("zmin_domain"  , zmin_domain)
  call get_parameter("xmax_domain"  , xmax_domain)
  call get_parameter("ymax_domain"  , ymax_domain)
  call get_parameter("zmax_domain"  , zmax_domain)
